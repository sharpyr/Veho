...
namespace Veho.Matrix {
  public static class MatrixReducers {
    ...
    public static T Reduce<T>(this T[,] matrix, Func<T, T, T> func) {
      ...
      for (var j = 1; j < w; j++) accum = func(accum, matrix[0, j]);
      for (var i = 1; i < h; i++)
        for (var j = 0; j < w; j++)
          accum = func(accum, matrix[i, j]);
      return accum;
    ...
    public static TO Reduce<T, TO>(this T[,] matrix, Func<TO, TO, TO> func, Func<T, TO> indicator) {
      ...
      for (var j = 1; j < w; j++) accum = func(accum, indicator(matrix[0, j]));
      for (var i = 1; i < h; i++)
        for (var j = 0; j < w; j++)
    ...
    public static T Reduce<T>(this T[,] matrix, Func<int, int, T, T, T> func) {
      ...
      if (h == 0 || w == 0) return default;
      var accum = matrix[0, 0];
      for (var j = 1; j < w; j++) accum = func(0, j, accum, matrix[0, j]);
      for (var i = 1; i < h; i++)
        for (var j = 0; j < w; j++)
          accum = func(i, j, accum, matrix[i, j]);
      return accum;
    ...
    public static TO Reduce<T, TO>(this T[,] matrix, Func<int, int, TO, TO, TO> func, Func<T, TO> indicator) {
      ...
      if (h == 0 || w == 0) return default;
      var accum = indicator(matrix[0, 0]);
      for (var j = 1; j < w; j++) accum = func(0, j, accum, indicator(matrix[0, j]));
      for (var i = 1; i < h; i++)
        for (var j = 0; j < w; j++)
  ...
  public static class RowReducers {
  ...
  public static class ColumnReducers {
