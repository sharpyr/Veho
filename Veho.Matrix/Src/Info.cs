namespace Veho.Matrix {
  public static class Info {
    ...
    public static (int, int) XLeap<T>(this T[,] matrix) => (matrix.GetLowerBound(0), matrix.GetLength(0));
    public static (int, int) YLeap<T>(this T[,] matrix) => (matrix.GetLowerBound(1), matrix.GetLength(1));
